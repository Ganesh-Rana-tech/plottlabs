                ...
                return (
                  <div key={milestone.year} className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'} animate-fade-in-up`} style={{ animationDelay: `${index * 200}ms` }}>
                    <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                      <div className={`inline-block px-6 py-3 rounded-full text-white font-bold text-lg mb-4 bg-gradient-to-r ${colorClasses[milestone.color as keyof typeof colorClasses]}`}>
                        {milestone.year}
                      </div>
                    ...
                    <div className="w-8 h-8 bg-white border-4 border-gray-300 rounded-full flex items-center justify-center relative z-10">
                      <div className={`w-4 h-4 rounded-full bg-gradient-to-r ${colorClasses[milestone.color as keyof typeof colorClasses]}`}></div>
                    </div>
      ...
      <section className="py-24 bg-gradient-to-br from-slate-50 to-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Decades of combined experience in public safety, technology, and mission-critical systems
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "30+ years experience guiding company strategy, partnerships, and compliance for global deployments.",
                color: "blue"
              },
              {
                name: "Cliff Gandy", 
                role: "Chief Technology Officer",
                description: "20+ years experience as cloud & systems architect for secure CAD/NG911 platforms.",
                color: "slate"
              },
              {
                name: "Cliff Veale",
                role: "Chief Financial Officer", 
                description: "30+ years experience in operations and federal public-safety systems leadership.",
                color: "blue"
              }
            ].map((leader, index) => {
              const colorClasses = {
              ...
              return (
                ...
                >
                  <CardContent className="p-8 text-center">
                    <div className={`w-20 h-20 mx-auto mb-6 bg-gradient-to-br ${colorClasses[leader.color as keyof typeof colorClasses]} rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                      <Users className="w-10 h-10 text-white" />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{leader.name}</h3>
                    <div className="text-lg font-semibold text-gray-600 mb-4">{leader.role}</div>
          ...
          <div className="text-center animate-fade-in-up">
            <Button size="lg" variant="outline" className="bg-white hover:bg-gray-50 text-gray-900 border-gray-300 hover:border-gray-400 hover:scale-105 transition-all duration-300">
              <Link href="/about#leadership">Meet the Full Team</Link>
            </Button>
          </div>
        </div>
      </section>
